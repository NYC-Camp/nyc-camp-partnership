...
/** 
 * Terminatur: 1b f3 18 cd 6b 59 45 55 d1 ae 
 * 
 * These local settings were generated by terminatur. 
 * You may see them if you use Kalastack, Kalabox, Proviso or other local dev tools. 
 * 
 */ 
if (isset($_SERVER['KALABOX']) &&  $_SERVER['KALABOX'] === 'on') { 
  ...
  $databases['default']['default'] = array( 
    'driver' => 'mysql',
    'database' => 'nyc_camp_partnership_kala', 
    'username' => 'root',
    'password' => 'password',
    'host' => 'localhost',
    'port' => '3306',
